...
router.get('/notifications/unread-count', authMiddleware, asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/notifications/:id/read', authMiddleware, asyncHandler(async (req: AuthRequest, res: Response) => {
  const userId = req.userId as number;
...
router.post('/notifications/read-all', authMiddleware, asyncHandler(async (req: AuthRequest, res: Response) => {
  const userId = req.userId as number;
