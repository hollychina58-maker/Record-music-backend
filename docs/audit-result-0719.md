...
### 第二轮修复（commit 56554ef）

| # | 处理 |
|:---|:---|
| P0-2 | ✅ HomePage hero/tag fetch 加 console.error |
| P1-5 | ✅ Skeleton.css 共享 + HomePage/MySpacePage 导入 |
| P1-4/6/7 | 🟡 后续 — EmptyState组件/loading toast需设计统一 |
| P2-8 | 🔜 跳过 — 闪现问题需 useLayoutEffect |
| P2-10 | 🟡 CheckoutPage深色是刻意设计 |
| P2-11 | ✅ StoryPoster字体改为var(--font-ink)；MusicBanner深色+金色是黑胶唱片风格 |
| P2-12 | 🟡 aria-busy需改骨架容器渲染，后续 |
